...
[Download 1.1.1](https://github.com/GpsLypy/NotchCalendar/releases/tag/v1.1.1) · [Release and validation notes](docs/quality/RELEASE_1.1.1.md). This manual-install build uses ad-hoc signing only, without Developer ID signing or notarization. Final performance and some hardware acceptance remain pending; see the [quality report](docs/quality/README.md).
