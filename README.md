...
The included GitHub Actions workflow creates a macOS ZIP archive and publishes it as a GitHub Release. The app’s **Check for Updates** button reads that release feed and opens the latest release when a newer version exists.
